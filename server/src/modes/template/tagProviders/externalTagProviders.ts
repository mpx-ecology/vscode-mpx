...
export const elementTagProvider = getExternalTagProvider(
  "element",
  elementTags,
  elementAttributes
);
export const onsenTagProvider = getExternalTagProvider(
  "onsen",
  onsenTags,
  onsenAttributes
);
export const bootstrapTagProvider = getExternalTagProvider(
  "bootstrap",
  bootstrapTags,
  bootstrapAttributes
);
export const buefyTagProvider = getExternalTagProvider(
  "buefy",
  buefyTags,
  buefyAttributes
);
export const gridsomeTagProvider = getExternalTagProvider(
  "gridsome",
  gridsomeTags,
  gridsomeAttributes
);

export function getRuntimeTagProvider(

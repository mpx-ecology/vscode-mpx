...
export {
  getComponentInfoTagProvider as getComponentTags
} from "./componentInfoTagProvider";
...
export function getTagProviderSettings(
  ...
  try {
    const packagePath = ts.findConfigFile(
      workspacePath,
      ts.sys.fileExists,
      "package.json"
    );
...
export function getEnabledTagProviders(
  tagProviderSetting: CompletionConfiguration
) {

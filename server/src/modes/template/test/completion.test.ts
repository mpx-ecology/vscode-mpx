...
//       .has("/body")
//       .become("<body><div><div></div></div></body  >");
...
//     noHTML`<el-tooltip |`
//       .has("content")
//       .withDoc("display content, can be overridden by slot#content");

//     noHTML`<el-popover |`
//       .has("content")
//       .withDoc("popover content, can be replaced with a default slot");

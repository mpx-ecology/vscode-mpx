...
const mouseModifiers = [
  genModifier(
    "left",
    'Triggers mouse event when "left" mouse button is clicked.'
  ),
  genModifier(
    "right",
    'Triggers mouse event when "right" mouse button is clicked.'
  ),
  genModifier(
    "middle",
    'Triggers mouse event when "middle" mouse button is clicked.'
  )
];
...
const systemModifiers = [
  genModifier(
    "ctrl",
    "Triggers mouse or keyboard event when <Control> is pressed."
  ),
  genModifier("alt", "Triggers mouse or keyboard event when <Alt> is pressed."),
  genModifier(
    "shift",
    "Triggers mouse or keyboard event when <Shift> is pressed."
  ),
  genModifier(
    "meta",
    "Triggers mouse or keyboard event when <Meta> is pressed."
  ),
  genModifier(
    "exact",
